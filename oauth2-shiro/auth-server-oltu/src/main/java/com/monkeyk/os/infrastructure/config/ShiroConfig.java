...
public class ShiroConfig {
    ...
    public DefaultWebSecurityManager defaultWebSecurityManager(MkkJdbcRealm userRealm) {
...
//        filterChainDefinitionMap.put("/**", "jwt");
    ...
    @Bean
    MkkJdbcRealm mkkJdbcRealm(DataSource dataSource){
        MkkJdbcRealm mkkJdbcRealm= new MkkJdbcRealm();
        mkkJdbcRealm.setDataSource(dataSource);
        //setCredentialsMatcher
        HashedCredentialsMatcher hashedCredentialsMatcher = new HashedCredentialsMatcher();
        hashedCredentialsMatcher.setHashAlgorithmName("MD5");
        mkkJdbcRealm.setCredentialsMatcher(hashedCredentialsMatcher);
        //setPermissionsLookupEnabled
        mkkJdbcRealm.setPermissionsLookupEnabled(true);
        return mkkJdbcRealm;
    }
}
